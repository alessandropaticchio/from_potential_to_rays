...
torch.save(potential_train_set, img_path + 'loaded_data/training_potential_unscaled.pt')
torch.save(potential_test_set, img_path + 'loaded_data/test_potential_unscaled.pt')
